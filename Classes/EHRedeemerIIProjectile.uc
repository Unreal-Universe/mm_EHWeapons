...
var	EHRedeemerIISmokeTrail SmokeTrail;
...
simulated function PostBeginPlay()
{
	...
	{
		SmokeTrail = Spawn(class'EHRedeemerIISmokeTrail',self,,Location - 40 * Dir, Rotation);
...
defaultproperties
{
     ...
     ExplosionEffectClass=Class'XEffects.NewExplosionA'
     Team=255
     Speed=2000.000000
     Damage=1450.000000
