...
static function StaticPrecache(LevelInfo L)
{
	...
	{
		L.AddPrecacheMaterial(Texture'EHWeaponSkinsB.ShockRifleTex02');
		L.AddPrecacheMaterial(Texture'WeaponSkins.ShockLaser.lasermist');
	}
    L.AddPrecacheMaterial(Material'EHWeaponSkinsB.pannelLightning');
    L.AddPrecacheMaterial(Material'EHWeaponSkinsB.ShockBeamPanner');
...
simulated function UpdatePrecacheMaterials()
{
	...
	{
		Level.AddPrecacheMaterial(Texture'EHWeaponSkinsB.ShockRifleTex02');
		Level.AddPrecacheMaterial(Texture'WeaponSkins.ShockLaser.lasermist');
	}
    Level.AddPrecacheMaterial(Material'EHWeaponSkinsB.pannelLightning');
    Level.AddPrecacheMaterial(Material'EHWeaponSkinsB.ShockBeamPanner');
...
defaultproperties
{
     ...
     InventoryType=Class'EHWeaponsE.EHShockRifle'
