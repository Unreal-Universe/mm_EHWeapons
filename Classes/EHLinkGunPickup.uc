...
static function StaticPrecache(LevelInfo L)
{
	if ( class'EHLinkGun'.Default.bUseOldWeaponMesh )
		L.AddPrecacheMaterial(Texture'tk_EHWeapons.EHWeaponSkinsB.LinkGunTex02');
...
simulated function UpdatePrecacheMaterials()
{
	if ( class'LinkGun'.Default.bUseOldWeaponMesh )
		Level.AddPrecacheMaterial(Texture'tk_EHWeapons.EHWeaponSkinsB.LinkGunTex02');
...
defaultproperties
{
     ...
     InventoryType=Class'tk_EHWeapons.EHLinkGun'
