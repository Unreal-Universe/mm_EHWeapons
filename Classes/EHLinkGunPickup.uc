...
static function StaticPrecache(LevelInfo L)
{
	if ( class'EHLinkGun'.Default.bUseOldWeaponMesh )
		L.AddPrecacheMaterial(Texture'mm_EHWeapons.EHWeaponSkinsB.LinkGunTex02');
...
simulated function UpdatePrecacheMaterials()
{
	if ( class'LinkGun'.Default.bUseOldWeaponMesh )
		Level.AddPrecacheMaterial(Texture'mm_EHWeapons.EHWeaponSkinsB.LinkGunTex02');
...
defaultproperties
{
     ...
     InventoryType=Class'mm_EHWeapons.EHLinkGun'
