...
// LinkGunPickup.
//=============================================================================
class EHLinkGunPickup extends UTWeaponPickup;
...
{
	if ( class'EHLinkGun'.Default.bUseOldWeaponMesh )
		L.AddPrecacheMaterial(Texture'EHWeaponSkinsB.LinkGunTex02');
    L.AddPrecacheMaterial(Texture'XEffectMat.link_muz_green');
    L.AddPrecacheMaterial(Texture'XEffectMat.link_muzmesh_green');
    L.AddPrecacheMaterial(Texture'EHWeaponSkinsB.LinkGreen');
...
simulated function UpdatePrecacheMaterials()
{
	if ( class'LinkGun'.Default.bUseOldWeaponMesh )
		Level.AddPrecacheMaterial(Texture'EHWeaponSkinsB.LinkGunTex02');
    ...
    Level.AddPrecacheMaterial(Texture'EHWeaponSkinsB.LinkGreen');
	...
	Level.AddPrecacheMaterial(Texture'EHWeaponSkinsB.LinkBlue');
	Level.AddPrecacheMaterial(Texture'XEffectMat.Link.link_muz_red');
	Level.AddPrecacheMaterial(Texture'EHWeaponSkinsB.LinkRed');
    ...
    Level.AddPrecacheMaterial(Texture'EHWeaponSkinsB.LinkYellow');
...
defaultproperties
{
     ...
     InventoryType=Class'EHWeaponsE.EHLinkGun'
     PickupMessage="You got the Enhanced Link Gun."
     PickupSound=Sound'PickupSounds.LinkGunPickup'
     PickupForce="EHLinkGunPickup"
