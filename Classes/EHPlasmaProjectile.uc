...
simulated function Explode(vector HitLocation,vector HitNormal)
{
    if ( Role == ROLE_Authority )
    {
   	...
   	PlaySound(SoundGroup'EHSounds.PlasmaHits',,2.5*TransientSoundVolume);
...
defaultproperties
{
     ...
     ComboAmmoCost=1
     ComboDamageType=Class'EHWeaponsE.DamTypeEHPlasmaBall'
     Speed=4150.000000
     ...
     MyDamageType=Class'EHWeaponsE.DamTypeEHPlasmaBall'
