class EHShockRifle extends tK_Weapon
...
function SetComboTarget(EHShockProjectile S)
{
...
function float RangedAttackTime()
{
	...
	return FMin(2,0.3 + VSize(B.Enemy.Location - Instigator.Location)/class'EHShockProjectile'.default.Speed);
}
...
function byte BestMode()
{
	...
	if ( B.Skill > 5 )
		MaxDist = 4 * class'EHShockProjectile'.default.Speed;
	else
		MaxDist = 3 * class'EHShockProjectile'.default.Speed;
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'mm_EHWeapons.EHShockBeamFire'
     FireModeClass(1)=Class'mm_EHWeapons.EHShockProjFire'
     SelectAnim="Pickup"
     PutDownAnim="PutDown"
     ...
     InventoryGroup=4
     PickupClass=Class'mm_EHWeapons.EHShockRiflePickup'
     PlayerViewOffset=(X=4.000000,Y=8.000000,Z=-2.000000)
     PlayerViewPivot=(Pitch=-1000)
     BobDamping=1.800000
     AttachmentClass=Class'mm_EHWeapons.EHShockAttachment'
