...
{
    L.AddPrecacheMaterial(Texture'EHWeaponSkinsB.AssaultRifleTex02');
...
simulated function UpdatePrecacheMaterials()
{
    ...
    Level.AddPrecacheMaterial(Texture'EHWeaponSkinsB.AssaultRifleTex02');
...
defaultproperties
{
     ...
     InventoryType=Class'EHWeaponsE.EHAssaultRifle'
