class EHRedeemerIIAttachment extends xWeaponAttachment;
...
defaultproperties
{
     ...
     DrawScale=0.600000
     Skins(0)=Texture'mm_EHWeapons.EHWeaponSkinsB.Rmissle2'
     Skins(1)=Texture'mm_EHWeapons.EHWeaponSkinsB.RedeemerTex02'
     AmbientGlow=12
     bShadowCast=True
