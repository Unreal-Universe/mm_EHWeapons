class EHGrenadeChunk extends Projectile;
...
simulated function PostBeginPlay()
{
    ...
    if ( Level.NetMode != NM_DedicatedServer )
    {
        ...
        {
            Trail = Spawn(class'AssaultTrail',self);
...
{
    if ( (EHGrenadeChunk(Other) == None) && ((Physics == PHYS_Falling) || (Other != Instigator)) )
    {
...
defaultproperties
{
     ...
     MyDamageType=Class'mm_EHWeapons.DamTypeEHGrenadeChunk'
