...
{
	L.AddPrecacheMaterial(Texture'mm_EHWeapons.EHWeaponSkinsB.SpiderRed');
	L.AddPrecacheMaterial(Texture'mm_EHWeapons.EHWeaponSkinsB.SpiderBLUE');
	L.AddPrecacheMaterial(Texture'mm_EHWeapons.EHWeaponSkinsB.EHminelayerTEX');
...
{
	Level.AddPrecacheMaterial(Texture'mm_EHWeapons.EHWeaponSkinsB.SpiderRed');
	Level.AddPrecacheMaterial(Texture'mm_EHWeapons.EHWeaponSkinsB.SpiderBLUE');
    Level.AddPrecacheMaterial(Texture'mm_EHWeapons.EHWeaponSkinsB.EHminelayerTEX');
...
defaultproperties
{
     ...
     InventoryType=Class'mm_EHWeapons.EHMineLauncher'
