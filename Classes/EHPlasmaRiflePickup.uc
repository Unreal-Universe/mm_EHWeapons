...
{
    L.AddPrecacheMaterial(Texture'mm_EHWeapons.EHWeaponSkinsB.LinkTex02');
    L.AddPrecacheMaterial(Texture'AW-2004Particles.Energy.SmoothRing');
    L.AddPrecacheMaterial(Texture'mm_EHWeapons.EHWeaponSkinsB.pannelLightning');
    ...
    L.AddPrecacheMaterial(FinalBlend'mm_EHWeapons.EHWeaponSkinsB.PlasmaFlashFB');
...
simulated function UpdatePrecacheMaterials()
{
    ...
    Level.AddPrecacheMaterial(Texture'mm_EHWeapons.EHWeaponSkinsB.LinkTex02');
    Level.AddPrecacheMaterial(Texture'AW-2004Particles.Energy.SmoothRing');
    Level.AddPrecacheMaterial(Texture'mm_EHWeapons.EHWeaponSkinsB.pannelLightning');
    ...
    Level.AddPrecacheMaterial(FinalBlend'mm_EHWeapons.EHWeaponSkinsB.PlasmaFlashFB');
...
defaultproperties
{
     ...
     InventoryType=Class'mm_EHWeapons.EHPlasmaRifle'
