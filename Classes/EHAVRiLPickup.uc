...
{
	L.AddPrecacheMaterial(Texture'EHWeaponSkinsB.EHAVRiLtex');
...
{
	Level.AddPrecacheMaterial(Texture'EHWeaponSkinsB.EHAVRiLtex');
...
defaultproperties
{
     ...
     InventoryType=Class'EHWeaponsE.EHAVRiL'
