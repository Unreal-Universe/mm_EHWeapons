// summon EHWeaponsE.ehonspainterpickup
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'EHWeaponsE.EHONSPainterFire'
     ...
     CenteredYaw=-500
     GroupOffset=2
     PickupClass=Class'EHWeaponsE.EHONSPainterPickup'
     PlayerViewOffset=(X=100.000000,Y=22.000000,Z=-32.500000)
     PlayerViewPivot=(Yaw=350)
     AttachmentClass=Class'EHWeaponsE.EHONSPainterAttachment'
