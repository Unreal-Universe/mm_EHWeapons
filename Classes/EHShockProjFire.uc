...
defaultproperties
{
     ...
     FireSound=Sound'tk_EHWeapons.EHSounds.EHShockAlt'
     ...
     ProjectileClass=Class'tk_EHWeapons.EHShockProjectile'
     BotRefireRate=0.350000
     FlashEmitterClass=Class'tk_EHWeapons.EHShockProjMuzFlash'
}
