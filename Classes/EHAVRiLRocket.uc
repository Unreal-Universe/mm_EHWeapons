...
simulated function Destroyed()
{
	...
	PlaySound(Sound'EHSounds.AvrilExplosion',,3.5*TransientSoundVolume);
	...
	if (ONSAVRiL(Owner) != None)
		ONSAVRiL(Owner).PlaySound(Sound'EHSounds.AvrilExplosion', SLOT_Interact, 0.01,, TransientSoundRadius);
...
defaultproperties
{
     ...
     MyDamageType=Class'EHWeaponsE.DamTypeEHAVRiLRocket'
     ...
     AmbientSound=Sound'EHSounds.EHAvrilProjectileLoop01'
     LifeSpan=7.000000
     DrawScale=0.200000
