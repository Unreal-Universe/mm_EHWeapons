...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter8
         ...
         ColorScale(2)=(RelativeTime=0.400000,Color=(G=135,R=225))
         ColorScale(3)=(RelativeTime=1.200000)
         MaxParticles=8
         UseRotationFrom=PTRS_Actor
         StartSpinRange=(X=(Max=1.000000))
         SizeScale(0)=(RelativeSize=1.500000)
         SizeScale(1)=(RelativeTime=1.200000,RelativeSize=2.200000)
     ...
     End Object
     Emitters(0)=SpriteEmitter'mm_EHWeapons.EHRedeemerIISmokeTrail.SpriteEmitter8'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter9
         ...
         ColorScale(2)=(RelativeTime=1.000000,Color=(B=50,G=50,R=50))
         MaxParticles=1000
     ...
     End Object
     Emitters(1)=SpriteEmitter'mm_EHWeapons.EHRedeemerIISmokeTrail.SpriteEmitter9'
