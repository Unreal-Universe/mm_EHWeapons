...
function Projectile SpawnProjectile(Vector Start, Rotator Dir)
{
    ...
    Warhead = Weapon.Spawn(class'EHWeaponsE.EHRedeemerIIWarhead', Instigator,, Start, Dir);
    if (Warhead == None)
		Warhead = Weapon.Spawn(class'EHWeaponsE.EHRedeemerIIWarhead', Instigator,, Instigator.Location, Dir);
    if (Warhead != None)
    {
