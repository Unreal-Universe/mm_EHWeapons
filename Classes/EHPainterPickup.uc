...
{
	L.AddPrecacheMaterial(Material'mm_EHWeapons.EHWeaponSkinsB.IonBeamPanner');
...
{
	Level.AddPrecacheMaterial(Material'mm_EHWeapons.EHWeaponSkinsB.IonBeamPanner');
...
defaultproperties
{
     ...
     InventoryType=Class'mm_EHWeapons.EHPainter'
