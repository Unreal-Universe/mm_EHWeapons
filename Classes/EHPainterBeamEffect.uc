class EHPainterBeamEffect extends xEmitter;

#exec OBJ LOAD FILE=XEffectMat.utx

var EHPainterBeamSpot Spot;
var Vector StartEffect, EndEffect;
var Vector EffectOffset;
var LinkMuzFlashBeam3rd MuzFlash;
var float Brightness;
var enum EHPainterTargetingState
{
    PTS_Aiming,
    PTS_Marked,
    PTS_Aquired,
...
{
    Spot = Spawn(class'EHPainterBeamSpot', self);
}
...
function SetTargetState(EHPainterTargetingState NewState)
{
...
simulated function Tick(float dt)
{
    ...
    else
    {
        if ( Instigator.IsFirstPerson() && Instigator.Weapon != None )
        {
            ...
            EndEffect = EHPainter(Instigator.Weapon).EndEffect;
        }
        else
        {
...
state Aquired
{
    ...
    simulated function SetTargetState(EHPainterTargetingState NewState)
    {
    }
}
...
defaultproperties
{
     ...
     Skins(0)=FinalBlend'EHWeaponSkinsB.PainterFinalBeam'
     Style=STY_Additive
     SoundVolume=45
