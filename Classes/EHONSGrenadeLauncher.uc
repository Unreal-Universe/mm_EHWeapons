class EHONSGrenadeLauncher extends tK_Weapon
	config(TKWeaponsClient);

#exec OBJ LOAD FILE=HudContent.utx

var array<EHONSGrenadeProjectile> Grenades;
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'mm_EHWeapons.EHONSGrenadeFire'
     FireModeClass(1)=Class'mm_EHWeapons.EHONSGrenadeAltFire'
     PutDownAnim="PutDown"
     ...
     Description="The Enhanced MGG Grenade Launcher fires magnetic sticky grenades, which will attach to enemy players and vehicles."
     ...
     InventoryGroup=7
     GroupOffset=1
     PickupClass=Class'mm_EHWeapons.EHONSGrenadePickup'
     PlayerViewOffset=(X=150.000000,Y=40.000000,Z=-46.000000)
     BobDamping=2.200000
     AttachmentClass=Class'mm_EHWeapons.EHONSGrenadeAttachment'
