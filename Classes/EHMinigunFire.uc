...
defaultproperties
{
     ...
     FiringSound=Sound'mm_EHWeapons.EHSounds.EHminiFire'
     EHMinigunSoundVolume=220
     WindUpTime=0.270000
     FiringForce="minifireb"
     WindingForce="miniempty"
     DamageType=Class'mm_EHWeapons.DamTypeEHMinigunBullet'
     DamageMin=7
     DamageMax=10
     Momentum=0.000000
     ...
     AmmoClass=Class'mm_EHWeapons.EHMinigunAmmo'
     AmmoPerFire=1
     ...
     FlashEmitterClass=Class'mm_EHWeapons.EHMinigunMuzFlash1st'
     SmokeEmitterClass=Class'mm_EHWeapons.EHMinigunMuzzleSmoke'
     aimerror=900.000000
     Spread=0.080000
