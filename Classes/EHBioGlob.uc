class EHBioGlob extends Projectile;
...
simulated function Destroyed()
{
    ...
    {
        Spawn(class'mm_EHWeapons.EHGoopSmoke');
...
auto state Flying
{
    simulated function Landed( Vector HitNormal )
    {
        ...
        GotoState('OnGround');
        Spawn(class'mm_EHWeapons.EHBioGoopSmoke');
    ...
    {
        local EHBioGlob Glob;

        Glob = EHBioGlob(Other);
...
defaultproperties
{
     ...
     MyDamageType=Class'mm_EHWeapons.DamTypeEHBioGlob'
