...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter0
         StaticMesh=StaticMesh'mm_EHWeapons.Simple.ParticleSphere3'
         RenderTwoSided=True
     ...
     End Object
     Emitters(0)=MeshEmitter'mm_EHWeapons.EHNewIonEffect.MeshEmitter0'
     ...
     End Object
     Emitters(1)=SpriteEmitter'mm_EHWeapons.EHNewIonEffect.SpriteEmitter0'
     ...
     End Object
     Emitters(2)=MeshEmitter'mm_EHWeapons.EHNewIonEffect.MeshEmitter1'

     Begin Object Class=MeshEmitter Name=MeshEmitter2
         StaticMesh=StaticMesh'mm_EHWeapons.Complex.IonSphere'
         RenderTwoSided=True
         UseParticleColor=True
         FadeOut=True
         RespawnDeadParticles=False
         ...
         LifetimeRange=(Min=3.000000,Max=3.000000)
     End Object
     Emitters(3)=MeshEmitter'mm_EHWeapons.EHNewIonEffect.MeshEmitter2'

     Begin Object Class=MeshEmitter Name=MeshEmitter3
         StaticMesh=StaticMesh'mm_EHWeapons.Complex.ExplosionRing'
         RenderTwoSided=True
         UseParticleColor=True
         FadeOut=True
         RespawnDeadParticles=False
         ...
         LifetimeRange=(Min=3.000000,Max=3.000000)
     End Object
     Emitters(4)=MeshEmitter'mm_EHWeapons.EHNewIonEffect.MeshEmitter3'
     ...
     End Object
     Emitters(5)=SpriteEmitter'mm_EHWeapons.EHNewIonEffect.SpriteEmitter10'
